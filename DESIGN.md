...
- ALL HTML reports generated by any VO agent (mAuditor, mScrumMaster, mPoster, pBugKiller, pHangScout, pEmailer, pDreamer)
...
- Teams-embedded HTML fragments (mPoster ICM summaries) -- these use Teams' own styling

### Migration Status (13 templates identified)

| Template | Status | Notes |
|----------|--------|-------|
| mScrumMaster-sprint-progress | DONE (0.2.0) | Was Old Blue (`#00d4ff`) |
| pBugKiller-scan | DONE (0.2.0) | Was Old Blue (`#00d4ff`) |
| pEmailer-scan | DONE (0.2.0) | Was GitHub Blue (`#58a6ff`) |
| pHangScout-daily-report | DONE (0.2.0) | Was GitHub Blue (`#58a6ff`) |
| pBugKiller-pr-maintenance | DONE (0.2.0) | Was Mixed (Material + Old Blue) |
| mAuditor-ytd-oof-summary | DONE (0.2.0) | Was GitHub Blue (`#58a6ff`) |
| mScrumMaster-shiproom-hygiene | DONE (0.2.0) | Was GitHub Blue (`#58a6ff`) |
| mAuditor-memory-consolidation | DONE (0.2.0) | Was light mode (white bg) |
| mAuditor-resolve-bugs-cleanup | DONE (0.2.0) | Was GitHub Blue (`#58a6ff`) |
| pBugKiller-daily-summary | DONE (0.2.0) | Was Old Blue (`#00d4ff`) |
| Portal ui/styles.css | DONE (0.2.0) | Added --vo-* vars, Inter font, weight 500/600 |
| mPoster-ba-perf-analysis | SKIP | Teams context (Teams own styling) |
| mPoster-icm-daily-summary | SKIP | Teams-embedded HTML fragment |
