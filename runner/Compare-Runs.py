#!/usr/bin/env python3
"""Compare mScrumMaster dry-run reports, detect problems, and create GitHub issues."""
...
OUTPUT_DIR = Path(__file__).resolve().parent.parent / "output" / "mScrumMaster"
        ...
        if total_bugs > 0 and needs_human == total_bugs:
            ...
            issues.append({
                ...
                "body": (
                    ...
                    + f"\n\n### Report\n\n`{r['path']}`"
                    + "\n\n---\n*Generated by Virtual Office mScrumMaster Compare-Runs*"
                ),
            })
...
def main():
    parser = argparse.ArgumentParser(description="Compare mScrumMaster dry-run reports")
