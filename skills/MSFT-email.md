...
- **Delete:** `workiq-delete_entity /me/messages/{id}` (→ Deleted Items)
...
- WorkIQ: `$skip` rejected (use a `receivedDateTime` cursor); **25 items/collection** cap; `messageRules` not exposed.
